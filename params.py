...
imgW = 800 # the width of the input image to network
nh = 256 # size of the lstm hidden state
nc = 1
pretrained = '' # path to pretrained model (to continue training)
expr_dir = 'expr2' # where to store samples and models
...
valInterval = 5000 # interval to val the model loss and accuray
saveInterval = 5000 # interval to save model
